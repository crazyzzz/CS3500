/*******************************************************************//**
 *      @author Ches Koblents, Portia Stephens, Kevin Langer
 *      @email ches@koblents.com stephensportia@gmail.com
 *		kplanger@gmail.com
 *	@group 8
 *      @date May 31, 2013
 *      @file TestFListInteger.java
 *      Assignment 7, CS3500, Summer 1 2013
 *	Group  8
 **********************************************************************/
...
public class TestFListInteger {
	...
	private void nonoverride() {
		try {
			...
			// commented out:
			// warning is useful, but not strictly necessary
			/*
